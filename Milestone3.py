...
class CWMachine(StateMachine):
    ...
    def transmit(self):
        ...
        while not self.endTransmission:
            ...
            ## Snapshot the current message so a button press can interrupt
            ## transmission cleanly and restart with the new message.
            ...
            for word in wordList:
                if self.endTransmission or messageToSend != self.activeMessage:
                    break
            ...
            if not self.endTransmission and messageToSend == self.activeMessage:
                self.doWP()
                self.doWP()
